package com.lyhcoding.myblog.core.advice;

import com.lyhcoding.myblog.core.exception.csr.ExceptionApi400;
...
public class MyValidAdvice {
    ...
    @Pointcut("execution(* com.lyhcoding.myblog.controller.api.*Controller.*(..))")
    public void api(){}

    @Pointcut("execution(* com.lyhcoding.myblog.controller.*Controller.*(..))")
    public void view(){}
